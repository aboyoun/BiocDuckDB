...
The `DuckDBDataFrame`, as its name suggests, is a `DataFrame` where the columns are derived from Parquet data.
...
At any point, users can retrieve the query to the underlying Parquet data via the `dbconn` method.
